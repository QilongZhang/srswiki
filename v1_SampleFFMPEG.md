...
FFMPEG对RTMP直播流转码，SRS在收到编码器推送的直播流后，可以对直播流进行转码，输出RTMP流到服务器（也可以到SRS自己）。详细规则参考：[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_FFMPEG)，本文列出了具体的部署的实例。
...
<strong>第三步，编写SRS配置文件。</strong>详细参考[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_FFMPEG)
...
<strong>第三步，启动SRS。</strong>详细参考[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_FFMPEG)

```bash
./objs/srs -c conf/ffmpeg.conf
```

<strong>第四步，启动推流编码器。</strong>详细参考[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_FFMPEG)
...
<strong>第五步，观看RTMP流。</strong>详细参考[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_FFMPEG)
...
<strong>第六步，观看FFMPEG转码的RTMP流。</strong>详细参考[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_FFMPEG)
