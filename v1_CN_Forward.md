...
备注：SRS的边缘RTMP参考[Edge](https://github.com/simple-rtmp-server/srs/wiki/v1_CN_Edge)，支持访问时回源，为大规模并发提供最佳解决方案。
...
转发的部署实例参考：[Usage: Forward](https://github.com/simple-rtmp-server/srs/wiki/v1_CN_SampleForward)
