...
<strong>第三步，编写SRS配置文件。</strong>详细参考[FFMPEG][FFMPEG]
...
<strong>第四步，启动SRS。</strong>详细参考[FFMPEG][FFMPEG]

```bash
./objs/srs -c conf/ffmpeg.conf
```

<strong>第五步，启动推流编码器。</strong>详细参考[FFMPEG][FFMPEG]
...
<strong>第六步，观看RTMP流。</strong>详细参考[FFMPEG][FFMPEG]
...
<strong>第七步，观看FFMPEG转码的RTMP流。</strong>详细参考[FFMPEG][FFMPEG]
