...
HLS需要h.264+aac，若符合这个要求可以按照[Usage: HLS](https://github.com/simple-rtmp-server/srs/wiki/v1_CN_SampleHLS)部署，若不符合这个要求则需要转码。

如何知道流是否是h264+aac编码：
* [Usage: HLS](https://github.com/simple-rtmp-server/srs/wiki/v1_CN_SampleHLS)中的`Q&A`说明的问题。
...
备注：这个配置使用只转码音频，因为视频是h.264符合要求，若需要全转码，参考[HLS+Transcode](https://github.com/simple-rtmp-server/srs/wiki/v1_CN_DeliveryHLS#wiki-hls%E5%92%8Ctranscode)
