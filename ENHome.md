...
## [How to ask questions](https://github.com/winlinvip/simple-rtmp-server/wiki/HowToAskQuestion-EN)
...
## [Edge搭建大型集群](https://github.com/winlinvip/simple-rtmp-server/wiki/Edge)
...
## [SRS的windows分支](https://github.com/winlinvip/simple-rtmp-server/wiki/WindowsSRS)

SRS在windows上支持到什么程度？客户端库支持得如何？服务器能在windows跑吗？参考：[SRS的windows分支](https://github.com/winlinvip/simple-rtmp-server/wiki/WindowsSRS)
...
## [Heartbeat](https://github.com/winlinvip/simple-rtmp-server/wiki/Heartbeat)
...
## [Perf性能分析](https://github.com/winlinvip/simple-rtmp-server/wiki/Perf)

如何使用内核性能分析工具分析srs性能？参考：[Perf性能分析](https://github.com/winlinvip/simple-rtmp-server/wiki/Perf)
...
## [Usage: HTTP](https://github.com/winlinvip/simple-rtmp-server/wiki/SampleHTTP)

使用实例：如何不依赖外部服务器分发HLS流？如何使用SRS内置的HTTP Server？参考：[Usage: HTTP](https://github.com/winlinvip/simple-rtmp-server/wiki/SampleHTTP)
