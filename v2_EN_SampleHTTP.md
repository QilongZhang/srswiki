...
<strong>Step 2, build SRS.</strong> For detail, read [Build](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Build)

```bash
./configure --disable-all --with-hls --with-ssl --with-http-server && make
```

<strong>Step 3, config srs.</strong> For detail, read [HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)和[HTTP服务器](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPServer)
...
read [HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)

<strong>Step 4, start srs.</strong> For detail, read [HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)
and [SRS HTTP Server](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPServer)

```bash
./objs/srs -c conf/http.hls.conf
```

<strong>Step 5, start encoder.</strong> For detail, read [HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)
...
<strong>Step 6, play RTMP.</strong> For detail, read [HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)
...
<strong>Step 7, play HLS.</strong> For detail, read [HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)
