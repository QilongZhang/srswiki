...
<strong>第四步，编写SRS源站配置文件。</strong>详细参考[RTMP分发](v1_CN_DeliveryRTMP)
...
<strong>第五步，编写SRS边缘配置文件。</strong>详细参考[RTMP分发](v1_CN_DeliveryRTMP)
...
<strong>第六步，启动SRS。</strong>详细参考[RTMP分发](v1_CN_DeliveryRTMP)
...
<strong>第七步，启动推流编码器。</strong>详细参考[RTMP分发](v1_CN_DeliveryRTMP)
...
<strong>第八步，观看RTMP流。</strong>详细参考[RTMP分发](v1_CN_DeliveryRTMP)
