...
* --with-dvr dvr RTMP to FLV file. Please read [DVR](v1_EN_DVR)
* --with-nginx build nginx to delivery HLS files and demo pages of SRS.
* --with-http-callback support http callback, for authentication, statistic and event handler. Please read [HTTP callback](v1_EN_HTTPCallback)
* --with-http-api support http api. Please read [HTTP API](v1_EN_HTTPApi)
...
* --with-kafka report log to Kafka cluster for big-data. Please read [Kafka](v1_EN_Kafka)
* --with-ffmpeg build FFMPEG for transcode, remux and ingest. Please read [FFMPEG](v1_EN_FFMPEG)
* --with-transcode live stream transcode. Please read [FFMPEG](v1_EN_FFMPEG)
...
* --jobs[=N] the parallelly process to build, sames to the -j/--jobs of make. Please read [Build: jobs](v1_EN_Build#jobs-speedup-build)
