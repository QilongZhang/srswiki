...
采集的部署实例参考：[Ingest](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_CN_SampleIngest)
...
* 其他参考转码的配置：[FFMPEG](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_CN_FFMPEG)
