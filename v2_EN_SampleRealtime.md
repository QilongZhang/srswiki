...
For detail about latency, read [LowLatency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency).
...
<strong>Step 3, config srs.</strong> For detail, read [LowLatency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency)
...
<strong>Step 4, start srs.</strong> For detail, read [LowLatency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency)

```bash
./objs/srs -c conf/realtime.conf
```

<strong>Step 5, start encoder.</strong> For detail, read [LowLatency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency)
...
<strong>Step 5, play RTMP.</strong> For detail, read [LowLatency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency)
