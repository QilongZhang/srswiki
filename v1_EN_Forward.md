...
Note: The information about edge, read [Edge](https://github.com/simple-rtmp-server/srs/wiki/v1_EN_Edge),
...
For the usage of forward, read [Usage: Forward](https://github.com/simple-rtmp-server/srs/wiki/v1_EN_SampleForward)
