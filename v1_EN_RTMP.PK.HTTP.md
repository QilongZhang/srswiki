...
互联网上的两种主要的分发方式：[HLS](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryHLS)和[RTMP](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryRTMP)，什么时候用谁，完全决定于应用场景。
...
参考[HTTP](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryHLS)和[RTMP](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryRTMP)
