...
The two major delivery methods on internet, [HLS](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryHLS)
and [RTMP](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryRTMP).
...
See [HTTP](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryHLS)
and [RTMP](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_EN_DeliveryRTMP)
