...
<strong>Step 3, config master SRS.</strong> For detail, read [Forward][Forward]
...
<strong>Step 4, start master SRS.</strong> For detail, read [Forward][Forward]

```bash
./objs/srs -c conf/forward.master.conf
```

<strong>Step 5, config slave SRS.</strong> For detail, read [Forward][Forward]
...
<strong>Step 6, start slave SRS.</strong> For detail, read [Forward][Forward]
...
<strong>Step 7, start encoder.</strong> For detail, read [Forward][Forward]
...
<strong>Step 8, play the stream on master.</strong> For detail, read [Forward][Forward]
...
<strong>Step 9, play the stream on slave.</strong> For detail, read [Forward][Forward]
