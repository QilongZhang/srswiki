...
可以打开`gprof.srs.log`查看性能报告，譬如([raspberry-pi下30个连接的性能数据](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_CN_RaspberryPi)）：
```bash
...
图片中一眼就能看出性能有问题的函数([raspberry-pi下30个连接的性能数据](https://github.com/winlinvip/simple-rtmp-server/wiki/v1_CN_RaspberryPi)），参考下图：
