...
The key features of SRS, the implemented, in plan and not plan. Please see: [SRS Features](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Features)
...
## [Build SRS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Build)

How to build SRS? How to enable or disable the feature of SRS? How to build and start the demo pages of SRS? Please see: [Build SRS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Build)
...
## [SRS Log](https://github.com/simple-rtmp-server/srs/wiki/v1_EN_SrsLog)
...
## [Delivery HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)

How to convert RTMP to delivery as HLS? What is HLS tech? How to config HLS in SRS? Please see: [Delivery HLS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHLS)

## [Delivery HDS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHDS)

How to convert RTMP to delivery as HDS? What is HDS tech? How to config HDS in SRS? Please see: [Delivery HDS](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DeliveryHDS)
...
How to choose delivering protocol? What about RTMP? What about HTTP? What about HLS? The history and use scenarios of RTMP, HTTP and HLS. Please see: [RTMP PK HLS](https://github.com/simple-rtmp-server/srs/wiki/v1_EN_RTMP.PK.HTTP)

## [Embeded HTTP Server](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPServer)

Can SRS support HTTP? How to delivery files over HTTP by SRS? Why SRS support embeded HTTP server? Can you use external HTTP Server? Please see: [Embeded HTTP Server](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPServer)

## [DVR record live stream] (https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DVR)

How to record live stream to flv file? How to record to pieces of files which start from keyframe with similar duration? What is the dvr plan, for example, segment and session plan? How to specify the path and filename? Please see: [DVR record live stream] (https://github.com/simple-rtmp-server/srs/wiki/v2_EN_DVR)
...
## [Low Latency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency)

How to use SRS in pseudo realtime? What is the latency? What is the mininum latency of SRS in commercial scenario, for example, CDN network? Please see: [Low Latency](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_LowLatency)

## [HTTP Callback](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPCallback)

About the HttpCallback or HttpHooks. How to authenticate the client? How to callback external http api when client publish stream? How to notice your system when client connect or disconnect? How to hook the dvr? Please see: [HTTP Callback](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPCallback)

## [HTTP Management API](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPApi)

How to manage server by http management api? How to manage server, for example, get server status in HTML pages? How your php/python management system to manage the SRS? Please see: [HTTP Management API](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_HTTPApi)
...
## [Stream Cast Service](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Streamer)

How to push RTSP to SRS? How does SRS accept RTSP stream? How to push MPEG-TS over UDP to SRS? How does SRS accept stream over other protocol? Read [Streamer](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Streamer)

## [Edge: Huge Live Cluster](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Edge)

How to use SRS in CDN? Does SRS suport the key freatures for CDN: vhost, edge, reload, http api and MIT source code? Why forward and ingest is not ok for huge live cluster? Does SRS support FMS edge mode? Please see: [Edge: Huge Live Cluster](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Edge)
...
## [Security: Allow or Deny clients](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Security)

How to apply security strategy? How to deny all publish and allow all play? How to deny clients by specified ip? Please see: [Security: Allow or Deny clients](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_Security)
...
## [SRS-librtmp](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_SrsLibrtmp)

Why SRS provides client rtmp library? How to use srs-librtmp? How to modify the amf0 metadata use srs-librtmp? How to get server debug info from srs-librtmp? Please see: [SRS-librtmp](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_SrsLibrtmp)
...
## [TimeJitter Timestamp Correct](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_TimeJitter)

How does SRS correct the timestamp of stream? How to correct the time jitter? How to ensure the timestamp of RTMP to monotonically increase? Please see: [TimeJitter Timestamp Correct](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_TimeJitter)
...
## [FLV VOD stream](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_FlvVodStream)

Does SRS support VOD? What about the FLV VOD stream? How to support time-shift for live stream? How to delivery the DVR files as VOD stream? Please see: [FLV VOD stream](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_FlvVodStream)
...
## [C++ IDE](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_IDE)

How to choose C++ IDE? We recomment the UltimateC++ or Clion. Please see: [C++ IDE](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_IDE)
...
Usage: How to use SRS to transcode stream(not h.264+aac) to delivery HLS? Please see: [Usage: Transcode2HLS](https://github.com/simple-rtmp-server/srs/wiki/v1_EN_SampleTranscode2HLS)
...
## [Usage: Realtime](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_SampleRealtime)

Usage: How to descrease the lantecy to <1s? How to config SRS in mininum latency mode? Please see: [Usage: Realtime](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_SampleRealtime)
...
## [Usage: HTTP](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_SampleHTTP)

Usage: How to delivery HLS without external HTTP server? How to use the embeded HTTP server of SRS? Please see: [Usage: HTTP](https://github.com/simple-rtmp-server/srs/wiki/v2_EN_SampleHTTP)
